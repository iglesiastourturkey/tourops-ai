 ...
 *
 * Review outcome: approvedAt/approvedBy (Phase 1c) mark a row approved and,
 * where applicable, the port_calls write that resulted. rejectedAt/rejectedBy
 * (Phase 2) mark a row reviewed and rejected - port_calls is never touched on
 * rejection. A row with both null is still pending review.
 */
