...
export const ConvertQuotationToOperationResponse = zod.object({
  ...
  "operationType": zod.union([zod.literal('CRUISE'),zod.literal('SEJOUR'),zod.literal(null)]).nullish(),
  ...
  "vehiclePlate": zod.string().nullish(),
  "guideResourceId": zod.number().nullish(),
  "driverResourceId": zod.number().nullish(),
