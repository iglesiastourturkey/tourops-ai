...
import { MapPin, FileText, Sparkles, AlertTriangle, Info, TrendingUp, Users, Calendar, CheckSquare } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const kpis = stats ? [
    ...
    { label: 'Tahmini Gelir', value: formatCurrency(stats.totalEstimatedRevenue, stats.currency), icon: TrendingUp, color: 'text-green-600', wide: true },
  ...
  return (
    <AppShell title="Kontrol Paneli">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-semibold">Hizli İşlemler</CardTitle>
          </CardHeader>
