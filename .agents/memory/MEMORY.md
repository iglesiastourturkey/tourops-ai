...
- [Password link flow](password-link-flow.md) — both "setup" and "reset" use POST /api/users/:id/password-reset (signInTokens.createSignInToken); passwordEnabled field on EnrichedUser drives the UI label distinction
